...
for i = 1, 6 do
  ...
  recipe.localised_name =
    {"recipe-name.slag-processing", {"item-name.angels-ore" .. i}}
...
if data.raw["assembling-machine"]["ore-sorting-facility-4"] then
  data.raw["assembling-machine"]["ore-sorting-facility-4"].next_upgrade =
...
seablock.lib.add_recipe_unlock(
  "advanced-ore-refining-4",
  "sb-ore-sorting-facility-5",
  3
)
...
for _, v in
  pairs({"angelsore-pure-mix1-processing", "angelsore-pure-mix2-processing"})
do
...
for _, v in
  pairs({-- Saphirite
  "angelsore1-crushed-processing", "angelsore1-chunk-processing", "angelsore1-crystal-processing", "angelsore2-chunk-processing", "angelsore2-crystal-processing", "angelsore3-crushed-processing", "angelsore3-chunk-processing", "angelsore3-crystal-processing", "angelsore4-chunk-processing", "angelsore4-crystal-processing", "angelsore5-crushed-processing", "angelsore5-chunk-processing", "angelsore5-crystal-processing", "angelsore6-crushed-processing", "angelsore6-chunk-processing", "angelsore6-crystal-processing"}) -- Jivolite -- Stiratite -- Crotinnium -- Rubyte -- Bobmonium
do
