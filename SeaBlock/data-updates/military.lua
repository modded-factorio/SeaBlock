...
local mil_items = {{
  ...
  type = "item",
  name = "liquid-glycerol-barrel"
}, {
  type = "item",
  name = "liquid-toluene-barrel"
}, {
  type = "item",
  name = "magazine"
}, {
  type = "item",
  name = "nitroglycerin-barrel"
}, {
  type = "item",
...
if data.raw.recipe["nutrients-refining-2"] then
  data.raw.recipe["nutrients-refining-2"].icons =
    angelsmods.functions.create_liquid_recipe_icon(
      {"liquid-fuel-oil", {"__base__/graphics/icons/fluid/water.png", 64}},
      {{214, 146, 040}, {169, 130, 039}, {120, 083, 004}}
    )
end

for i = 1, 6 do
  seablock.lib.remove_effect(
    "physical-projectile-damage-" .. i,
    "turret-attack",
    "turret_id",
    "bob-gun-turret-3"
  )
  ...
  seablock.lib.remove_effect(
    "weapon-shooting-speed-" .. i,
    "gun-speed",
    "ammo_category",
    "shotgun-shell"
  )
  seablock.lib.remove_effect(
    "laser-shooting-speed-" .. i,
    "gun-speed",
    "ammo_category",
    "laser-rifle"
  )
  seablock.lib.remove_effect(
    "stronger-explosives-" .. i,
    "ammo-damage",
    "ammo_category",
    "landmine"
  )
...
local mil_techswap = {-- 150 Red, Green, Blue, Purple
{
