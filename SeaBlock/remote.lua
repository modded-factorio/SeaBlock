...
local function milestones_presets()
  ...
  grouped_milestones["science"] = {
    ...
    script.active_mods["bobtech"] and
    {type="item",       name="advanced-logistic-science-pack", quantity=1} or nil,
    ...
    script.active_mods["bobtech"] and
    {type="item",       name="advanced-logistic-science-pack", quantity=1000, next="x10"} or nil,
  ...
  -- Progress
  local seablock_default_landfill = 
    script.active_mods["LandfillPainting"] and 
    settings.startup["sb-default-landfill"] and 
    settings.startup["sb-default-landfill"].value or "landfill"
  ...
  if script.active_mods["SpaceMod"] then
    grouped_milestones["SpaceX"] = {
      ...
      script.active_mods["bobtech"] and
      {type="technology", name="ftl-theory-D",         quantity=1} or nil,
